        ...
        for(standing of standings){
            ...
            for(row of standing.table){
                tableContent += `
                    ...
                    <div class="col-sm-2 align-center"><p class="text-success">${row.won}</p></div>
                    <div class="col-sm-2 align-center"><p class="text-danger">${row.lost}</p></div>
                    <div class="col-sm-2 align-center"><p class="text-secondary">${row.draw}</p></div>
                    <div class="col-sm-2 align-center"><b><b class="text-info">${row.points}</b></b></div>
                    </div>
                </li>
                `
            }
